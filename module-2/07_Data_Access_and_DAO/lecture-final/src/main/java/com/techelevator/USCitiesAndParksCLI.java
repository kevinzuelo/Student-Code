...
public class USCitiesAndParksCLI {
    ...
    private void retrievePark() {
        int parkId = promptForInt("Enter park id to retrieve: ");
    ...
    private void displayMenu() {
        ...
        System.out.println("5. Retrieve park by id");
    ...
    private Park promptForPark() {
        ...
        while (true) {
            try {
                int selection = promptForInt("Please select a park (0 to Exit): ");
                if (selection != 0) {
