<template>
  <div class="main">
    ...
    <div class="well-display">
      ...
      <div class="well" v-for="n in 5" v-bind:key="n" v-bind:class="{ filtered: n == filter }">
        <span class="amount" v-on:click="filter = n">{{ numberOfReviews(n) }}</span>
...
export default {
  ...
  methods: {
    addNewReview() {
      if (this.newReview.reviewer && this.newReview.rating) {
