...
public class KilometerConverter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter a kilometer value to start with: ");
        ...
        System.out.println("Going from " + kilometerStart + "km to "
            + kilometerEnd + "km in increments of " + incrementBy + "km.");
