...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		your phone.
		*/
		int percentBatteryLeft = 30;
		System.out.println(percentBatteryLeft);


		System.out.println("Total = " + (percentBatteryLeft + mouseButtons));
		...
		*/
		...
		int differenceBetweenNums = 121 - 27;

		/*
		11. Create a double that holds the addition of 12.3 and 32.1.
		*/
		double myAddition = 12.3 + 32.1;

		/*
		12. Create a String that holds your full name.
		*/
		String firstName = "Ben";
		String lastName = "Langhinrichs";
		...
		*/
		...
		the same variable.
		*/
		String formalGreeting = greeting + " " + "Esquire";
