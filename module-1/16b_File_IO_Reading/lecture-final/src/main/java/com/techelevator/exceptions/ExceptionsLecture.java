...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		System.out.println("I am happily continuing with my program.");
		System.out.println();
		...
		try {
			System.out.println("Our instructor is " + firstName.toLowerCase() + " " + lastName.toLowerCase());
		}
		catch (Exception e) {
			//System.out.println("Ugh. Somebody forgot the instructor's name.");
		}

		System.out.println("I am still happily continuing with my program.");
		System.out.println();
		...
		try {
			...
			System.out.println("You did number formatting wrong...");
		}
		...
		catch(InvalidHotelArgumentException e) {
			System.out.println("Corrupted data. Number of guests specified as "+numberOfGuests+". Number of nights specified as "+nights+".");
...
//
	...
	private static double calculateHotelRoomCharges(int nights, int numberOfGuests) {
		...
		if(nights < 1) {
			throw new InvalidHotelArgumentException("Minimum number of nights is 1");
		}

		if(numberOfGuests < 1) {
			throw new InvalidHotelArgumentException("Minimum number of guests is 1");
		}

		if (numberOfGuests > 6) {
			throw new IllegalArgumentException("Maximum number of guests is 6. Try our sister hotel, Dominco Suites");
		}
